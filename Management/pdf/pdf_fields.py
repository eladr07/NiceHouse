...
class ProjectNameAndCityField(TableField):
    def __init__(self):
        return super(ProjectNameAndCityField, self).__init__(u'הפרוייקט\nשם',  
                                                             130)
    def format(self, item):
...
class ProjectInitiatorField(TableField):
    def __init__(self):
        return super(ProjectInitiatorField, self).__init__(u'היזם\nשם',  
                                                             150)
    def format(self, item):
...
class MonthField(TableField):
    def __init__(self):
        return super(ProjectInitiatorField, self).__init__(u'חודש',  None)
    def format(self, item):
...
class DemandSalesCountField(TableField):
    def __init__(self):
        return super(DemandSalesCountField, self).__init__(u"מכירות\nמס'",
...
class DemandSalesTotalPriceField(TableField):
    def __init__(self):
        return super(DemandSalesTotalPriceField, self).__init__(u'מכירות\nסה"כ',
...
class DemandTotalAmountField(TableField):
    def __init__(self):
        return super(DemandTotalAmountField, self).__init__(u'עמלה\nסה"כ',
                                                           50, is_commaised = True, is_summarized = True)
    def format(self, item):
...
class InvoicesNumField(TableField):
    def __init__(self):
        return super(InvoicesNumField, self).__init__(u"מס' ח-ן",
                                                           50)
    def format(self, item):
...
class InvoicesAmountField(TableField):
    def __init__(self):
        return super(InvoicesAmountField, self).__init__(u"סך ח-ן",
                                                           50)
    def format(self, item):
        return Paragraph('<br/>'.join([str(i.num) for i in item.invoices.all()]), styleRow9)
...
class PaymentsNumField(TableField):
    def __init__(self):
        return super(PaymentsNumField, self).__init__(u"מס' צ'ק",
                                                           50)
    def format(self, item):
        return Paragraph('<br/>'.join([str(i.num) for i in item.invoices.all()]), styleRow9)
...
class PaymentsAmountField(TableField):
    def __init__(self):
        return super(PaymentsAmountField, self).__init__(u"סך צ'ק",
                                                           50)
    def format(self, item):
        return Paragraph('<br/>'.join([str(i.num) for i in item.invoices.all()]), styleRow9)
