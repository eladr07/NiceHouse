...
urlpatterns = patterns('',
    ...
    (r'^nhemployeesalaries/(?P<id>\d+)/details$', 'Management.views.nhemployee_salary_details',
     {'model':NHEmployeeSalary}),
    (r'^nhemployeesalaries/(?P<id>\d+)/checkdetails$', 'Management.views.nhemployee_salary_check_details',
     {'model':NHEmployeeSalary}),
    (r'^nhemployeesalaries/(?P<id>\d+)/totaldetails$', 'Management.views.nhemployee_salary_total_details',
     {'model':NHEmployeeSalary}),
    ...
    (r'^nhsaleside/(?P<object_id>\d+)$', 'Management.views.limited_update_object',
         {'form_class' : Management.forms.NHSaleSideForm,
          ...
          'post_save_redirect' : '%(id)s'}),
    (r'^nhsaleside/(?P<object_id>\d+)/payment/add$', 'Management.views.nhsale_payment_add'),
