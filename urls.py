...
urlpatterns = patterns('',
    ...
    (r'^contacts/$', 'Management.views.limited_object_list',
    ...
    (r'^projects/archive$', 'Management.views.limited_object_list',
    ...
    (r'^projectcommission/(?P<object_id>\d+)$', 'Management.views.limited_update_object',
    ...
    (r'^buildings/(?P<object_id>\d+)/pricelist/type(?P<type_id>\d+)/pdf$', 'Management.views.building_pricelist_pdf'),
    ...
    (r'^employees/(?P<obj_id>\d+)/reminders$', 'Management.views.obj_reminders',
     {'model': Employee}),
    (r'^employees/(?P<object_id>\d+)/loans$', 'Management.views.limited_object_detail',
    ...
    (r'^employees/$', 'Management.views.limited_object_list',
    ...
    (r'^employees/archive$', 'Management.views.limited_object_list',
    ...
    (r'^nhemployees/(?P<obj_id>\d+)/reminders$', 'Management.views.obj_reminders',
     {'model': EmployeeBase}),
    (r'^nhemployees/(?P<object_id>\d+)/loans$', 'Management.views.limited_object_detail',
    ...
    (r'^demands/(?P<object_id>\d+)/sales$', 'Management.views.limited_object_detail',
    ...
    (r'^demandfollowup$', 'Management.views.demand_followup_list'),
    (r'^demandfollowup/(?P<project_id>\d+)/(?P<from_year>\d+)/(?P<from_month>\d+)/(?P<to_year>\d+)/(?P<to_month>\d+)$', 'Management.views.demand_followup_list'),
    ...
    (r'^employeesalaryseason$', 'Management.views.employeesalary_season_list'),
    (r'^employeesalaryseason/(?P<employee_id>\d+)/(?P<from_year>\d+)/(?P<from_month>\d+)/(?P<to_year>\d+)/(?P<to_month>\d+)$', 'Management.views.employeesalary_season_list'),
    ...
    (r'^employeesalaries/(?P<object_id>\d+)/details$', 'Management.views.limited_object_detail',
     {'queryset':EmployeeSalary.objects.all(),
      'template_name':'Management/employee_commission_details.html',
      'template_object_name':'salary',
      'context_processors':[RequestContext]}),
    (r'^employeesalaries/(?P<object_id>\d+)/checkdetails$', 'Management.views.limited_object_detail',
     {'queryset':EmployeeSalary.objects.all(),
      'template_name':'Management/employee_salary_check_details.html',
      'template_object_name':'salary',
      'context_processors':[RequestContext]}),
    (r'^employeesalaries/(?P<object_id>\d+)/totaldetails$', 'Management.views.limited_object_detail',
     {'queryset':EmployeeSalary.objects.all(),
    ...
    (r'^nhemployeesalaries/(?P<object_id>\d+)/details$', 'Management.views.limited_object_detail',
     {'queryset':NHEmployeeSalary.objects.all(),
      'template_name':'Management/nhemployee_commission_details.html',
      'template_object_name':'salary',
      'context_processors':[RequestContext]}),
    (r'^nhemployeesalaries/(?P<object_id>\d+)/checkdetails$', 'Management.views.limited_object_detail',
     {'queryset':NHEmployeeSalary.objects.all(),
      'template_name':'Management/employee_salary_check_details.html.html',
      'template_object_name':'salary',
      'context_processors':[RequestContext]}),
    (r'^nhemployeesalaries/(?P<object_id>\d+)/totaldetails$', 'Management.views.limited_object_detail',
     {'queryset':NHEmployeeSalary.objects.all(),
      'template_name':'Management/employee_salary_total_details.html',
      'template_object_name':'salary',
      'context_processors':[RequestContext]}),
    ...
    (r'^reports/employeesalary_season/(?P<employee_id>\d+)/(?P<from_year>\d+)/(?P<from_month>\d+)/(?P<to_year>\d+)/(?P<to_month>\d+)$', 'Management.views.report_employeesalary_season'),
    
    (r'^madadbi/$', 'Management.views.limited_object_list',
     {'queryset':MadadBI.objects.all(),
      'template_name':'Management/madadbi_list.html',
      'context_processors':[RequestContext]}),
    (r'^madadbi/add$', 'Management.views.limited_create_object',
         {'form_class' : Management.forms.MadadBIForm,
          'template_name' : 'Management/object_edit.html',
          'permission':'add_madadbi',          
          'post_save_redirect' : '%(id)s'}),
    (r'^madadbi/(?P<object_id>\d+)$', 'Management.views.limited_update_object',
         {'form_class' : Management.forms.MadadBIForm,
          'template_name' : 'Management/object_edit.html',
          'permission':'change_madadbi',          
          'post_save_redirect' : '%(id)s'}),
    (r'^madadbi/(?P<id>\d+)/del$', 'Management.views.madadbi_del'),
    
    (r'^madadcp/$', 'Management.views.limited_object_list',
     {'queryset':MadadCP.objects.all(),
      'template_name':'Management/madadcp_list.html',
      'context_processors':[RequestContext]}),
    (r'^madadcp/add$', 'Management.views.limited_create_object',
         {'form_class' : Management.forms.MadadCPForm,
          'template_name' : 'Management/object_edit.html',
          'permission':'add_madadcp',          
          'post_save_redirect' : '%(id)s'}),
    (r'^madadcp/(?P<object_id>\d+)$', 'Management.views.limited_update_object',
         {'form_class' : Management.forms.MadadCPForm,
          'template_name' : 'Management/object_edit.html',
          'permission':'change_madadcp',          
          'post_save_redirect' : '%(id)s'}),
    (r'^madadcp/(?P<id>\d+)/del$', 'Management.views.madadcp_del'),
    
    (r'^tax/$', 'Management.views.limited_object_list',
    ...
    (r'^demand_details/(?P<project>\d+)/(?P<year>\d+)/(?P<month>\d+)$', 'Management.views.demand_details'),
