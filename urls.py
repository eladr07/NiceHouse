...
urlpatterns = patterns('',
    ...
    (r'^projects/end/(?P<id>\d+)/$', 'Management.views.project_end'),
    ...
    (r'^employees/(?P<object_id>\d+)/$', 'Management.views.limited_update_object',
     {'form_class' : Management.forms.EmployeeForm,
      ...
      'post_save_redirect' : '/employees/%(id)s'}),
    (r'^employees/end/(?P<id>\d+)/$', 'Management.views.employee_end'),
    ...
    (r'^employees/(?P<id>\d+)/account/del$', 'Management.views.employee_account_delete'),
    ...
    (r'^attachment/(?P<object_id>\d+)$', 'Management.views.limited_update_object',
     {'form_class' : Management.forms.AttachmentForm,
      ...
      'post_save_redirect' : 'attachment/%(id)s'}),
    ...
    (r'^demands/unpaid$', 'Management.views.demand_unpaid_list'),
    (r'^demands/paidsome$', 'Management.views.demand_paidsome_list'),
    (r'^demandsold$', 'Management.views.demand_old_list'),
    (r'^demands/closeall$', 'Management.views.demand_closeall'),
    (r'^demands/sendall$', 'Management.views.demand_sendall'),
    ...
    (r'^reports/project_month/(?P<project_id>\d+)/(?P<year>\d+)/(?P<month>\d+)/pdf$', 'Management.views.report_project_month_pdf'),
    ...
    (r'^site_media/(?P<path>.*)$', 'django.views.static.serve',
        {'document_root': '/hsphere/local/home/nicehouse/nicehouse.co.il/NiceHouse/media',
         'show_indexes': True}),
)
