...
urlpatterns += patterns('Management.views',
    ...
    (r'^employees/(?P<employee_id>\d+)/(?P<commission>\d+)/project/(?P<project_id>\d+)$', 'employee_commission_add'),
    (r'^employees/(?P<employee_id>\d+)/(?P<commission>\d+)/project/(?P<project_id>\d+)/del$', 'employee_commission_del'),
