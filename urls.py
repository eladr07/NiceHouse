...
urlpatterns = patterns('',
    ...
    (r'^employeesalaries/(?P<id>\d+)/details$', 'Management.views.limited_object_detail',
    ...
    (r'^employeesalaries/(?P<object_id>\d+)/checkdetails$', 'Management.views.limited_object_detail',
     {'queryset':EmployeeSalary.objects.all(),
      ...
      'template_object_name':'salary',
      'context_processors':[RequestContext]}),
    (r'^employeesalaries/(?P<id>\d+)/totaldetails$', 'Management.views.limited_object_detail',
     {'queryset':EmployeeSalary.objects.all(),
    ...
    (r'^nhemployeesalaries/(?P<id>\d+)/details$', 'Management.views.limited_object_detail',
     {'queryset':NHEmployeeSalary.objects.all(),
      'template_name':'Management/nhemployee_commission_details.html',
      'template_object_name':'salary',
      'context_processors':[RequestContext]}),
    (r'^nhemployeesalaries/(?P<id>\d+)/checkdetails$', 'Management.views.limited_object_detail',
     {'queryset':NHEmployeeSalary.objects.all(),
      'template_name':'Management/employee_salary_check_details.html.html',
      'template_object_name':'salary',
      'context_processors':[RequestContext]}),
    (r'^nhemployeesalaries/(?P<id>\d+)/totaldetails$', 'Management.views.limited_object_detail',
     {'queryset':NHEmployeeSalary.objects.all(),
      'template_name':'Management/employee_salary_total_details.html',
      'template_object_name':'salary',
      'context_processors':[RequestContext]}),
