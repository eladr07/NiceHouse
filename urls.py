...
urlpatterns += patterns('Management.views',
    ...
    (r'^projects/\d+/reminder/(?P<object_id>\d+)$', 'limited_update_object',
     {'form_class' : Management.forms.ReminderForm, 'template_name' : 'Management/object_edit.html', 'post_save_redirect' : '../reminders'}),
    ...
    (r'^buildings/(?P<object_id>\d+)/pricelist/type(?P<type_id>\d+)/clientspdf$', 'building_clients_pdf'),
    ...
    (r'^employees/\d+/reminder/(?P<object_id>\d+)$', 'limited_update_object',
     {'form_class' : Management.forms.ReminderForm, 'template_name' : 'Management/reminder_edit.html', 'post_save_redirect' : '../reminders'}),
    ...
    (r'^demands/(?P<object_id>\d+)/sales$', 'limited_object_detail',
     {'queryset':Demand.objects.all(), 'template_name':'Management/demand_sales.html', 'template_object_name':'demand',
      'context_processors':[RequestContext]}),
    ...
    (r'^lawyers/(?P<id>\d+)/del$', 'limited_delete_object',
     {'model':Lawyer, 'post_delete_redirect':'/loans'}),
